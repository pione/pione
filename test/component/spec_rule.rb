...
describe 'Pione::Component::ActionRule' do
  before do
    ...
    @cond_a = Component::RuleCondition.new([@data_a], [@data_a], params: @params_a, features: Feature.and(@f_a))
    @cond_b = Component::RuleCondition.new([@data_b], [@data_b], params: @params_b, features: Feature.and(@f_b))
  end

  it 'should be equal' do
    a = Component::ActionRule.new(@rule_a, @cond_a, 'echo "a"')
    b = Component::ActionRule.new(@rule_a, @cond_a, 'echo "a"')
    a.should == b
  end

  it 'should be not equal' do
    a = Component::ActionRule.new(@rule_a, @cond_a, 'echo "a"')
    b = Component::ActionRule.new(@rule_b, @cond_b, 'echo "b"')
    a.should != b
  end

  it 'should be action rule' do
    Component::ActionRule.new(@rule_a, @cond_a, 'echo "a"').should.action
  end

  it 'should be not flow rule' do
    Component::ActionRule.new(@rule_a, @cond_a, 'echo "a"').should.not.flow
  end
...
describe 'Pione::Component::FlowRule' do
  ...
  it 'should be equal' do
    a = Component::FlowRule.new(@rule_a, @cond_a, 'echo "a"')
    b = Component::FlowRule.new(@rule_a, @cond_a, 'echo "a"')
    a.should == b
  end

  it 'should be not equal' do
    a = Component::FlowRule.new(@rule_a, @cond_a, 'echo "a"')
    b = Component::FlowRule.new(@rule_b, @cond_b, 'echo "b"')
    a.should != b
  end

  it 'should be flow rule' do
    Component::FlowRule.new(@rule_a, @cond_a, 'echo "a"').should.flow
  end

  it 'should be not action rule' do
    Component::FlowRule.new(@rule_a, @cond_a, 'echo "a"').should.not.action
  end
end
