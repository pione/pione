...
task 'test' do
  sh "bundle exec bacon -I lib -rsimplecov test/log/spec_*.rb test/location/spec_*.rb test/component/spec_*.rb test/util/spec_*.rb test/tuple/spec_*.rb test/uri-scheme/spec_*.rb test/agent/spec_*.rb test/rule-engine/spec_*.rb test/system/spec_*.rb test/command/spec_*.rb"
end
